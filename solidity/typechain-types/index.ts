...
export type { BrowniePoints } from "./contracts/brownie.sol/BrowniePoints";
export { BrowniePoints__factory } from "./factories/contracts/brownie.sol/BrowniePoints__factory";
